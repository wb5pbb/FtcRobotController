    ...
    @TeleOp(name = "opmode_spin_steer_parallel_balance3 (Blocks to Java)", group = "")
    public class opmode_spin_steer_parallel_balance3 extends LinearOpMode {
...
*/
        ...
        public void runOpMode() {
            ...
            steeringDeadband = 0.0005;
            servoTest1.setPosition(servo1zero + oneeighty);
            servoTest2.setPosition(servo2zero + 0.0);
            servoTest3.setPosition(servo3zero + 0.0);
            servoTest4.setPosition(servo4zero + oneeighty);
            armServo1.setPosition(armServo1zero);
            gripServo1.setPosition(degree2servo*90.0);
            parallelAngle = 0.0;
            steeringOn = 0.0;
            spinOn = 0.0;
            turnRadius = 0.0;
            ...
            if (opModeIsActive()) {
                ...
                while (opModeIsActive()) {
                    ...
                    while(gamepad1.dpad_up) {
                        servoTest1.setPosition(gamepad1.right_stick_x + oneeighty);
                        servoTest2.setPosition(gamepad1.right_stick_y + 0.0);
                        servoTest3.setPosition(gamepad1.left_stick_x + 0.0);
                        servoTest4.setPosition(gamepad1.left_stick_y + oneeighty);
                        telemetry.addData("servo 0", gamepad1.right_stick_x);
                        telemetry.addData("servo 1", gamepad1.right_stick_x);
                        telemetry.addData("servo 2", gamepad1.right_stick_x);
                        telemetry.addData("servo 3", gamepad1.right_stick_x);
                        telemetry.update();
                    }

                    // Put loop blocks here.
                    if(gamepad1.right_bumper) {
                        gripServo1.setPosition(gripServo1zero + (1.0-(0.4*gamepad1.right_trigger)));
                    }
                    if(gamepad1.left_bumper){
                        armServo1.setPosition(armServo1zero+ degree2servo*200.0*gamepad1.left_trigger);
                    }
                    //telemetry.addData( "grip", gamepad1.right_trigger );
                    ...
                    if (gamepad1.y || parallelOn != 0) {
                        ...
                        while (spinOn != 0) {
                            if(gamepad1.left_bumper){
                                armServo1.setPosition(armServo1zero+ degree2servo*100.0);
                            }
                            if(!gamepad1.left_bumper){
                                armServo1.setPosition(armServo1zero);
                            }
